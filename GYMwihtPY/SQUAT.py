...
def perfect_leg():
    ...
    try:
        cursor.execute("INSERT INTO workouts (visitor_id,workout) VALUES (?,?)", (id_entry.get(), "perfect leg"))
        conn.commit()
...
def dumbels_only():
    ...
    try:
        cursor.execute("INSERT INTO workouts (visitor_id,workout) VALUES (?,?)", (id_entry.get(), "leg dumbels only"))
        conn.commit()
    except Exception as e:
        print(e)
