...
def Strength():
    ...
    try:
        cursor.execute("INSERT INTO workouts (visitor_id,workout) VALUES (?,?)", (id_entry.get(), "Strength abs"))
        conn.commit()
...
def Beginners():
    ...
    try:
        cursor.execute("INSERT INTO workouts (visitor_id,workout) VALUES (?,?)", (id_entry.get(), "beginner abs"))
        conn.commit()
    except Exception as e:
        print(e)
