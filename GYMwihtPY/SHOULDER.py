...
def boulder():
    ...
    try:
        cursor.execute("INSERT INTO workouts (visitor_id,workout) VALUES (?,?)", (id_entry.get(), "boulder"))
        conn.commit()
...
def dumbels_only():
    ...
    try:
        cursor.execute("INSERT INTO workouts (visitor_id,workout) VALUES (?,?)", (id_entry.get(), "dumbels only"))
        conn.commit()
    except Exception as e:
        print(e)
