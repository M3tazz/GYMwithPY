...
def open_third_window(current_root):
    current_root.destroy()
    import third_window
    third_window.main_third()
...
def main_second():
    ...
    left_button = tk.Button(root, text="<<<", command=lambda: open_first_window(root), bg="black", fg="white", font=("Arial", 20, "bold"), bd=0)
