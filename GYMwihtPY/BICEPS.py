...
def dumbels_only():
    ...
    try:
        cursor.execute("INSERT INTO workouts (visitor_id,workout) VALUES (?,?)", (id_entry.get(), "arm dumbels only"))
        conn.commit()
...
def bigger_arms():
    ...
    try:
        cursor.execute("INSERT INTO workouts (visitor_id,workout) VALUES (?,?)", (id_entry.get(), "big arms"))
        conn.commit()
    except Exception as e:
        print(e)
